...
const Radio = ({ color, className, ...rest }: RadioProps) => {
  return (
    <input
      type="radio"
      ...
      before:left-1/2 before:h-3 before:w-3 before:-translate-x-1/2 before:rounded-full
      before:transition-all dark:border-gray-800
      ${
        color === "red"
